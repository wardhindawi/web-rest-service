...
public class PersonResource {
    ...
    @GET
    @Path ("/{personId}")
    public Response getPerson(@PathParam ("personId")
    long id, @Context
    UriInfo uriInfo) {
    ...
    private String getUriForSelf(Person person, UriInfo uriInfo) {
        String uri = uriInfo.getBaseUriBuilder().path(PersonResource.class).path(Long.toString(person.getId())).build()
                .toString();
        return uri;
    ...
    private String getUriForInsurance(Person person, UriInfo uriInfo) {
        ...
        String uri = uriInfo.getBaseUriBuilder().path(PersonResource.class)
                .path(PersonResource.class, "getInsuranceResource").path(InsuranceResource.class)
